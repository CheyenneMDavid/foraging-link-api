...
The function to validate images is a direct copy from the Code Institute
DRF-API walkthrough project, from the posts app, serializer file.
"""
...
class PlantInFocusSerializer(serializers.ModelSerializer):
    ...
    def validate_image(self, value):
        """
        Validation for the file size and dimensions of the image before
        it's uploaded. If the filesize or image dimensions are outside the
